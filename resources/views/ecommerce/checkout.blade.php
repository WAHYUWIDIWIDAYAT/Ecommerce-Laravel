		...
		<div class="container" style="margin-top:80px;">
            ...
            <h3>Informasi Pengiriman</h3>          
              ...
              <form class="row contact_form" action="{{ route('front.store_checkout') }}" method="post" novalidate="novalidate">
                            @csrf
                        <div class="col-md-12 form-group p_star" style="margin-top:50px;">
                    ...
                    <div class="card" style="width: 350px; margin: auto;">
                        ...
                        <tbody>
                            <tr>
                            <td>
                                <h8>@foreach ($carts as $cart)
                                    <p>{{ \Str::limit($cart['product_name'], 10) }}
                            ...
                            <td>
                                <h8>Rp {{ number_format($subtotal) }}</h8>
                            </td>
                            </tr>
                            <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <h8><td><button class="btn btn-primary">Bayar Pesanan </button></td></h8>
                        </tbody>
                        </table>
                    </div>
                    </div>
