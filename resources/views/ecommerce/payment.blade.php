                    ...
                    <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="transfer_to" class="form-control" required>
                                ...
                                <option value="BCA: 0000000">BCA: 0000000 : Wahyu widi widayat</option>
                                <option value="BRI: 0000000">BRI: 0000000 : Wahyu widi widayat</option>
                                <option value="BANK JATENG: 0000000">BANK JATENG: 0000000 : Wahyu widi widayat</option>
                                <option value="COD">COD : Bayar ditempat (kolom bukti bisa diganti ss pesanan )</option>
                            </select>
